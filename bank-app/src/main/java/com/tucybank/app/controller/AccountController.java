...
public class AccountController {
	...
	// curl -X GET "http://localhost:8080/findAccountById?idAccount=1"
		...
		// curl -H 'Content-Type: application/json' -X DELETE http://localhost:8080/deleteAccount/1
		...
		// curl -H 'Content-Type: application/json' -d '{ "idAcount":"1", "idClient":"1", "totalBalance":"500"}' -X PUT http://localhost:8080/updateAccount
