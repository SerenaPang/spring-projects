...
public class AuthorController {
	...
	// curl -H 'Content-Type: application/json' -d '{ "id":"25", "name":"AAAB"}' -X POST http://localhost:8080/saveAuthor
	...
	// curl -H 'Content-Type: application/json' -d '{ "id":"5", "name":"MMMMM"}' -X PUT http://localhost:8080/updateAuthor
	...
	// curl -X GET "http://localhost:8080/findBookById?id=2"
		...
		// curl -H 'Content-Type: application/json' -d '{ "id":"5", "name":"ABCD", "isbn":"CRFGHJ56Y7 "id_author":"1"}' -X POST http://localhost:8080/save
		@PostMapping("/save{book}")
		public void saveAuthor(@RequestBody Book book) {
			authorDao.save(book);
		}

		// curl -H 'Content-Type: application/json' -X DELETE http://localhost:8080/deleteBook/1
		...
		// curl -H 'Content-Type: application/json' -d '{ "id":"5", "name":"MMMMM", "isbn":"45f-gh56-8gh", "id_author":"5"}' -X PUT http://localhost:8080/update
